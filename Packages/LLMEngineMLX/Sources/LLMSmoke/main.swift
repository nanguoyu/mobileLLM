...
// Fork acceptance gate. If bits=1 quantizedMM runs and matches the reference, the PrismML
...
if r.passed {
    print("✅ PASS — PrismML fork's quantizedMM(bits:1) runs and matches dequantize·matmul.")
} else {
